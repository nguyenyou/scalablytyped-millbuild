...
import org.scalablytyped.converter.internal.scalajs.{ContainerTree, HasCodePath, QualifiedName, Tree, Versions}
import bloop.io.AbsolutePath
import org.scalablytyped.converter.internal.IArray
import org.scalablytyped.converter.internal.IArray.Empty
...
object ImportScalajsDefinitions {
  ...
  val projectRoot: os.Path = {
    ...
    def containsBuildSbt =
      os.list(current).exists(_.last == "build.mill")
